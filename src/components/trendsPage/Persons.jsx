      ...
      {personDetail.name && (
        <Row>
          <Col span={12} className="personInfoBox">
            ...
            <h1><span>name : </span>{personDetail.name}</h1>
            <h1><span>known for department : </span>{personDetail.known_for_department}</h1>
            <h1><span>gender : </span>{personDetail.gender === 1 ? "female" : 'male'}</h1>
            <Button type="danger"><Link to={`/celebrity/${personDetail.id}`}>get more detail</Link></Button>
            </div>
          </Col>
